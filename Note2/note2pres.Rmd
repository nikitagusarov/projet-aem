...
```{r echo = FALSE, fig.cap = "Les résidus et les prédictions"}
par(mfrow = c(1,2), cex = 0.5)
...
stargazer(pDW,
    header = FALSE,
    title = "Le resultats du test de Durbin-Watson",
    summary = FALSE)
```
...
```{r echo = FALSE, fig.cap = "L'autocorrelation pour le modèle  i3SLS"}
par(mfrow = c(1,2), cex = 0.5)
...
# 8. Clustering et la séparation des groupes (Between transformation approach)
